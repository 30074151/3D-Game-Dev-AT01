...
public class KeyBindManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            keys.Add(actionSetUp[i].actionName, (KeyCode)Enum.Parse(typeof(KeyCode), 
                PlayerPrefs.GetString(actionSetUp[i].actionName, actionSetUp[i].defaultKey)));
    ...
    void ChangeKey(GameObject clickedKey)
    {
    ...
    private void OnGUI()
    {
        ...
        if (currentKey != null)
        {
            ...
            {
                newKey = changeKeyEvent.keyCode.ToString();
                newKeyCode = changeKeyEvent.keyCode;
            }
        }
    }
}
